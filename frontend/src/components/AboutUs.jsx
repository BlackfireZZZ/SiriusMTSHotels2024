...
const AboutUs = ({ aboutUsRef }) => {
    return (
        <div className="ld-container container" ref={aboutUsRef}>
                    ...
                    <div className="vc_column-inner vc_custom_1607345714802">
                        <div className="wpb_wrapper ca-initvalues-applied lqd-animations-done"
                            ...
                            <div className="ld-fancy-heading ld_fancy_heading_634d4b2e1e1f0 lqd-unit-animation-done"
                                 style={{}}><h6
                                className="ld-fh-element lqd-highlight-underline lqd-highlight-grow-left text-decoration-default" style={{color: '#ff0032ff'}}> Кто мы </h6></div>
                            <div className="ld-fancy-heading mask-text ld_fancy_heading_634d4b2e1e32c">
                                <h2 className="ld-fh-element lqd-highlight-underline lqd-highlight-grow-left text-decoration-default lqd-split-words ca-initvalues-applied lqd-animations-done split-text-applied"
                                    ...
                                    <div style={{position: 'relative', display: 'inline-block'}}
                                         className="split-unit lqd-words"><span className="split-inner"> Что делает нас особенными?</span>
                                    </div>
                                </h2>
                            </div>
                            ...
                            Это слаженность нашей команды, высокая квалификация каждого из её участников, неравнодушность к продукту и клиенту  </p></div>
                        </div>
                    </div>
                </div>
                <div
                                            ...
                                            <div className="vc_column-inner vc_custom_1607345614090">
                                                <div className="wpb_wrapper">
                                                    <div
                                                        ...
                                                        style={{}}><h5
                                                        className="ld-fh-element lqd-highlight-underline lqd-highlight-grow-left text-decoration-default">
                                                        Понимаем потребности клиента</h5></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div className="vc_column-inner vc_custom_1607345688852">
                                                <div className="wpb_wrapper">
                                                    <div
                                                        ...
                                                        style={{}}><h5
                                                        className="ld-fh-element lqd-highlight-underline lqd-highlight-grow-left text-decoration-default"> Постоянно развиваемся</h5>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="vc_column-inner vc_custom_1607345703224">
                                                <div className="wpb_wrapper">
                                                    <div
                                                        ...
                                                        style={{}}><h5
                                                        className="ld-fh-element lqd-highlight-underline lqd-highlight-grow-left text-decoration-default"> Имеем большой опыт за плечами</h5></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
